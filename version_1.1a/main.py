...
# =======================================================================
hyperionColumns =['EC','Ar Subject','Remarks','Common Trench','EFV Valve', 'Main Depth', 'Main Loc',"Main Mat'l",'Main Pressure',
...
workOrderColumns =['Work Order Nbr', 'Ar Number', 'Repair Date', 'Crew Leader', 'Repair Made to Stop Leak?', 'Remarks', 'New Remarks', 'Svc Supply', 'Repair Method']  
